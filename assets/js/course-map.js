/* ==========================================================================
   ...
   本站收录范围：第 1 次课 — 第 32 次课，共 32 课 / 64 课时（截至 2026-09-26 全部 ready）。
   注：第 6 课是实操课基准模板 A、第 7 课是理论课基准模板 B，转化新课以前两者为参照。
   ========================================================================== */
...
window.COURSE_MAP = {
  meta: {
    ...
    totalHours: 64,
    sessionMinutes: 80,
    scopeNote: "全站收录第 1–32 次课，共 32 课。",
    updated: "2026-09-26",
  },
  ...
  modules: [
    {
      ...
      name: "AIGC 理论基础",
      range: "第 1–6 次课",
      note: "讲清原理，为工具实战打底。1–5 课为原理导入，6 课起进入工具实战。",
      lessons: [
        {
          no: 1,
          week: 1,
          title: "AI 发展史与运行原理初探",
          subtitle: "文字接龙、Token 与温度：大模型怎么说话",
          type: "理论", theory: 2, practice: 0,
          sections: "暂无对应学习通章节",
          lms: "",
          status: "ready",
          file: "lessons/lesson-01-history.html",
          summary: "AI 发展里程碑、对话式 AI 的文字接龙本质、Token 与概率采样、首次 AI 体验与标注规范。",
          tags: ["AI 发展史", "Token", "提示词"],
        },
        {
          no: 2,
          week: 1,
          title: "神经网络与 Transformer",
          subtitle: "AI 的大脑结构",
          type: "理论", theory: 2, practice: 0,
          sections: "暂无对应学习通章节",
          lms: "",
          status: "ready",
          file: "lessons/lesson-02-transformer.html",
          summary: "神经网络基本结构、注意力机制给重要词打高分、Transformer 与文字接龙的关系。",
          tags: ["神经网络", "Transformer", "注意力"],
        },
        {
          no: 3,
          week: 1,
          ...
          lms: "",
          status: "ready",
          file: "lessons/lesson-03-training.html",
          summary: "预训练与后训练的分工、SFT 岗前培训比喻、亲手测 AI 的知识边界与幻觉。",
          tags: ["预训练", "SFT", "幻觉"],
        },
        {
          no: 4,
          week: 2,
          title: "RLHF 与强化学习",
          subtitle: "DeepSeek R1 深度解析",
          type: "理论", theory: 2, practice: 0,
          sections: "暂无对应学习通章节",
          lms: "",
          status: "ready",
          file: "lessons/lesson-04-rlhf.html",
          summary: "RLHF 如何对齐人类偏好、安全拒答是训练出来的结果、奖励模型与过度拒绝的代价。",
          tags: ["RLHF", "强化学习", "对齐"],
        },
        {
          no: 5,
          week: 2,
          title: "AI 绘图原理",
          subtitle: "Stable Diffusion 深度解析",
          type: "实操", theory: 0, practice: 2,
          sections: "暂无对应学习通章节",
          lms: "",
          status: "ready",
          file: "lessons/lesson-05-sd.html",
          summary: "扩散模型原理、提示词对照实验、控制变量归因与参数实验记录表。",
          tags: ["Stable Diffusion", "扩散模型", "提示词"],
        },
...

    {
      ...
      lessons: [
        ...
        },
        {
          ...
          status: "ready", file: "lessons/lesson-27-codex.html",
        ...
        },
        {
          ...
          status: "ready", file: "lessons/lesson-28-hermes.html",
        ...
        },
        {
          ...
          status: "ready", file: "lessons/lesson-29-harness.html",
        ...
        },
        {
          ...
          status: "ready", file: "lessons/lesson-30-learning.html",
        ...
        },
        {
          ...
          status: "ready", file: "lessons/lesson-31-jobpack.html",
        ...
        },
        {
          ...
          status: "ready", file: "lessons/lesson-32-defense.html",
