...
window.SITE_SECTION_INDEX = [
  ...
  /* ── 第 27 次课 · Codex 入门：你的 AI 编程搭档（实操） ── */
  ...
  /* ── 第 28 次课 · Hermes-Agent：会成长的开源个人 AI 助手（理论） ── */
  ...
  /* ── 第 29 次课 · DeepSeek-Harness：一切皆插件的 Agent 框架（实操） ── */
